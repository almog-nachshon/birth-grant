...
scripts/         seed לקטלוג, אבחון מפתחות, הרצת מיגרציות
...
(Google ומייל), אזור אישי עם טאבים ואחוזי השלמה, מסך התיק, יומן, העלאת מסמכים
ממוינים, מחשבון ציבורי, עמוד בית, שכבת AI.
